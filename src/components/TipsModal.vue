  ...
  <Teleport to="body">
    ...
    >
      ...
      <div
        ...
        tabindex="-1"
        class="relative z-1 flex max-h-[min(85dvh,560px)] w-full max-w-md flex-col overflow-hidden rounded-2xl bg-white shadow-[0_24px_48px_-12px_rgba(0,0,0,0.22)] ring-1 ring-black/8 dark:bg-neutral-900 dark:shadow-[0_24px_48px_-12px_rgba(0,0,0,0.55)] dark:ring-white/10"
        @click.stop
      >
